...
// Note: designTokens import is commented out - this is a demo page
          ...
          <CardContent className="space-y-6">
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {/* Design tokens demo - uncomment import to enable */}
                <div className="text-center">
                  <div className="w-16 h-16 rounded-lg border border-gray-200 mx-auto mb-2 bg-blue-500" />
            ...
            <div>
              ...
              <div className="space-y-4">
                {/* Typography demo - uncomment designTokens import to enable */}
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="font-medium">heading-lg</h4>
                    <div className="text-sm text-gray-500">24px / 32px / 600</div>
                  </div>
