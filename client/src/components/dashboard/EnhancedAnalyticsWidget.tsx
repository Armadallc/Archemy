        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <h5 className="text-sm font-medium text-muted-foreground">Total Revenue</h5>
                  <DollarSign className="h-4 w-4 text-muted-foreground" />
                </div>
                <p className="text-2xl font-bold mt-1 text-gray-900 dark:text-gray-100">${analyticsData?.totalRevenue.toLocaleString()}</p>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <h5 className="text-sm font-medium text-muted-foreground">Trips Completed</h5>
                  <CheckCircle className="h-4 w-4 text-muted-foreground" />
                </div>
                <p className="text-2xl font-bold mt-1 text-gray-900 dark:text-gray-100">{analyticsData?.tripsCompleted.toLocaleString()}</p>
                <div className="flex items-center text-sm mt-1">
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <h5 className="text-sm font-medium text-muted-foreground">Active Drivers</h5>
                  <Car className="h-4 w-4 text-muted-foreground" />
                </div>
                <p className="text-2xl font-bold mt-1 text-gray-900 dark:text-gray-100">{analyticsData?.activeDrivers}</p>
                <div className="flex items-center text-sm mt-1">
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <h5 className="text-sm font-medium text-muted-foreground">Completion Rate</h5>
                  <CheckCircle className="h-4 w-4 text-muted-foreground" />
                </div>
                <p className="text-2xl font-bold mt-1 text-gray-900 dark:text-gray-100">{analyticsData?.completionRate}%</p>
                <div className="flex items-center text-sm mt-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <h5 className="text-lg font-semibold mb-3">Peak Hours</h5>
              <div className="h-64">
