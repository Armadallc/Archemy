...
export function useDndEvents() {
  ...
  const { activeIdRef, draggableDescribedById, triggerEvent, setActiveId } = context;
...
export const kanbanBoardColumnClassNames =
  'w-64 flex-shrink-0 rounded-lg border flex flex-col bg-sidebar py-2 max-h-full';
...
const kanbanBoardCardClassNames =
  'rounded-lg border bg-background p-3 text-start text-foreground shadow-sm';
  ...
  const button = (
    <div
      className={cn(
        ...
        'size-5 border hover:cursor-default [&_svg]:size-3.5',
        className,
      )}
