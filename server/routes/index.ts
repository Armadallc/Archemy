...
import programManagementRoutes from "./program-management";
import locationRoomBedsRoutes from "./location-room-beds";
...
router.use("/program-management", programManagementRoutes);
router.use("/location-room-beds", locationRoomBedsRoutes);
