...
-- ============================================================================
-- SPECIAL REQUIREMENTS TABLE (editable list for trips)
-- ============================================================================
...
-- Special Requirements indexes
CREATE INDEX IF NOT EXISTS idx_special_requirements_active ON special_requirements(is_active);
CREATE INDEX IF NOT EXISTS idx_special_requirements_display_order ON special_requirements(display_order);
...
CREATE TRIGGER update_special_requirements_updated_at BEFORE UPDATE ON special_requirements FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
-- Insert default special requirements
INSERT INTO special_requirements (id, name, is_custom, display_order, is_active) VALUES
('sr_door_to_door', 'Door to Door', false, 1, true),
('sr_curb_to_curb', 'Curb to Curb', false, 2, true),
('sr_soft_landing', 'Soft Landing (driver escorts client to/from)', false, 3, true),
('sr_pickup_paperwork', 'Driver needs to: Pick up paperwork', false, 4, true),
('sr_dropoff_paperwork', 'Driver needs to: Drop off paperwork', false, 5, true),
('sr_other', 'Other', true, 6, true)
ON CONFLICT (id) DO NOTHING;
